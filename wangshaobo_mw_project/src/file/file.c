...
void add_string(uint_32 send_or_rec,float_64 data,uint_32 port){
    byte_8 a[20]={0};
    //加互斥锁
...
void judge_result(void){
    ...
    uint_32 buf_len=strlen(buffer);
    printf("正在分析测试结果...\n");
    t t_node[4000];
    uint_32 hash_t[4000]={0};
    uint_32 pos=0;
    int i=0;
    int t=0;
    //printf("buf_len:%d\n",buf_len);
