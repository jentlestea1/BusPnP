...
#define IRQMP_ICLEAR          *(volatile uint_32 *)(IRQMP_BASE+0xc)
#define MASK_IRQ(cpu,irq)     (*(volatile uint_32 *)(IRQMP_P0_MASK_START+cpu*4))|=(1<<irq)
#define UN_MASK_IRQ(cpu,irq)  (*(volatile uint_32 *)(IRQMP_P0_MASK_START+cpu*4))&=(~(1<<irq))
